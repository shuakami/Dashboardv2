...
export default function PrivacyComponent() {
    ...
    const content = {
        ...
        en: {
            ...
            policyChanges: "This Privacy Policy may be updated from time to time. We will do our best to notify you of any significant changes through console site security or other means. Continuing to use the console will be regarded as your acceptance of these changes.",
